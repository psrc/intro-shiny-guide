...
After opening the `.Rproj` file, you'll see some like changes to your IDE. Your console and `Files` pane will reflect the new working directory, and the project name is listed in the top right corner.
