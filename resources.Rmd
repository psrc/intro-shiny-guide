...
**[Mastering Shiny Book](https://mastering-shiny.org/index.html)**: A book (in progress) by Hadley Wickham. See the `Getting Started` section. For developers who use the tidyverse, the book also includes a section on the latest *tidy evaluation*--helpful for programming with packages like dplyr or ggplot2.
