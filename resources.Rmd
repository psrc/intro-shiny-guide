...
**[Mastering Shiny Book](https://mastering-shiny.org/index.html)**: A book (in progress) by Hadley Wickham. See the *Getting Started* section. For those who use the tidyverse, it also includes a section on the latest version of *tidy evaluation*--helpful for programming with packages like dplyr or ggplot2.
