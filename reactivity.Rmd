...
Shiny [maximizes the work not done](https://medium.com/lapis/reflection-on-principle-10-simplicity-the-art-of-maximizing-the-amount-of-work-not-done-is-99520e0654dc)! In other words, it's energy-saving and will only do the most minimal work required to update outputs.
...
In the example below, we add an action button to create an event (on-click).
